...
<body>
  <div class="wrapper d-flex flex-column">
    ...
    <div class="align-self-center w-75 main-body">
      <h3 class="text-center text-decoration-underline pb-3">Cart List</h3>

      <table class="table cart-list table-light m-3 text-center">
        <thead>
          <tr>
            ...
            <td class="text-center">
              <div class="input-group d-inline-flex">
                <div class="input-group-prepend">
                  <button class="btn btn-outline-secondary minusBtn" type="button" id="">-</button>
                </div>
                <input type="text" class="form-control text-center quantityInput" value="1" id="">
                <div class="input-group-append">
                  <button class="btn btn-outline-secondary plusBtn" type="button" id="">+</button>
                </div>
              </div>
            </td>
            <td class="totalPrice">2000</td>
            <td><button type="button" class="btn btn-danger deleteBtn"><i class="fas fa-times"></i></button></td>
          </tr>
          <tr>
