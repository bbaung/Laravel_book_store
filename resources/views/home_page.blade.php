...
<head>
  ...
  <style>
    ...
    .card {
      width: 100%; /* Adjust the width of cards to fill the container */
      border: none; /* Remove default card borders */
      transition: transform 0.3s ease-in-out; /* Add a smooth transition effect */
    }
    .card:hover {
      transform: scale(1.03); /* Scale up the card on hover for emphasis */
    }
    .footer {
      height: 100px; /* Increase footer height */
      background-color: #343a40; /* Darker background color */
      color: #fff; /* Text color */
      padding-top: 25px; /* Add top padding for content */
    }
...
<body>
  <div class="wrapper d-flex flex-column">
    <div class="w-100 mb-5 fixed-top" style="z-index: 1;">
    ...
    <div class="container-fluid align-self-center w-75 bg-body-tertiary main-body">
      <div class="row">
        <h3 class="d-inline col-6">Best Selling Books</h3>
        <a class="d-inline-block fs-5 text-end col-6" href="#">View All</a>
      </div>
      <div class="row my-5">
        <div class="col-2">
