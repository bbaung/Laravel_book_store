												...
												<section class="container-fluid">
																<div class="row container-fluid container">
																				...
																				<div class="col-md-3 edit_book mt-4">
																								...
																								<input type="date" name="releaseDate" class="form-control form-control-sm mt-3"
																												placeholder="input">
																				...
																				<div class="col-md-6">
																								...
																								<input accept="image/*" type="file" class="btn btn-outline-muted edit_book mt-2 border"
																												name="bookImage" id="">
																				</div>
																</div>
												</section>
