            ...
            <form action="" method="post">
                <div class="row container-fluid container">
                    ...
                    <div class="col-md-3 edit_book mt-4">
                        <input type="text" class="form-control form-control-sm mt-3 border" placeholder="input">
                        ...
                        <input type="text" name="Categories" class="form-control form-control-sm mt-3" placeholder="input">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" class="btn btn-outline-muted edit_book mt-2 border" name=""
                            id="">
                    </div>
                </div>
            </form>
